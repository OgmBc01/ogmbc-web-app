...
?> 
        ...
        <div class="col-md-4">
          <div class="card h-100 shadow-sm border-0" style="background-color:#f7f0d9;">
            <div class="card-body">
              ...
              <p class="mb-0"><strong>Tel:</strong> +971 50 986 0136</p>
            </div>
          </div>
        </div>
        <!-- Delaware Office -->
        <div class="col-md-4">
          <div class="card h-100 shadow-sm border-0" style="background-color:#f7f0d9;">
            <div class="card-body">
              ...
              <p class="lead mb-1">O.G.M. Holding Co. Ltd</p>
        ...
        <div class="col-md-4">
          <div class="card h-100 shadow-sm border-0" style="background-color:#f7f0d9;">
            <div class="card-body">
              ...
              <p class="lead mb-1">O.G.M Consultants UK Ltd</p>
  ...
  <section class="py-5">
    <div class="container text-center mb-5">
      <h2 class="fw-bold">Find Us on<span style="color:#d0aa4b;"> Google</span> Map</h2>
      <p class="lead"></p>
    <!-- Contact Form + Map -->
  ...
  <section class="cta-section py-5">
    <div class="container">
      <div class="container text-center mb-5">
        <h2 class="fw-bold">We are Just a<span style="color:#d0aa4b;"> Click</span> Away</h2>
