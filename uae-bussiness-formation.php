...
?> 
  ...
  <section class="about-hero d-flex align-items-center text-center text-white">
    <div class="container">
      <h1 class="display-4 fw-bold">UAE Business Formation</h1>
      <p class="lead">Welcome to OGMBC. Your Trusted Partner in UAE Company Formation.</p>
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center">
          ...
          <li class="breadcrumb-item active text-white" aria-current="page">UAE Business Formation</li>
        </ol>
      </nav>
    </div>
  </section>
  ...
  <section class="section process-section">
    <div class="container text-center">
      <!-- Heading -->
      <h2 class="fw-bold mb-4">Our Company Formation Process</h2>

      <!-- Steps -->
      <div class="row g-4">
        <!-- Step 1 -->
        <div class="col-md-4">
          <div class="card process-card h-100 p-4">
      ...
      <div class="text-start">
        <p class="lead fw-semibold text-light text-start">
          Embark on your UAE business journey with confidence and ease. Contact OGMBC today for a consultation, and let our experts guide you through the seamless process of company formation in the UAE. 
          <br>Your success begins with the right partner, and at OGMBC, we are committed to being that partner for you.
        </p>
      </div>
    </div>
  </section>
