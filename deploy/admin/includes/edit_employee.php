...
$field_of_study = $qualification = $highest_graduation = $year_of_graduation = $current_image = '';
$message = '';
$message_type = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($user_id) || empty($user_email) || empty($password) || empty($first_name) || empty($last_name)) {
        ...
        $stmt = $connection->prepare($sql);
        $stmt->bind_param("issssssssii", $user_id, $user_email, $password, $first_name, $last_name, 
                         $user_image, $field_of_study, $qualification, $highest_graduation, $year_of_graduation, $employee_id);
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-primary btn-lg me-2">
                                        <i class="bi bi-check-circle me-1"></i> <?php echo $employee_id > 0 ? 'Update Employee' : 'Add Employee'; ?>
                                    </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p>The employee information has been updated in the database.</p>
            </div>
