                        ...
                        <div class="col-md-6 text-md-end">
                            <div class="page-navigation-group">
                                <div class="btn-group" role="group">
                                    ...
                                    <input type="radio" class="btn-check" name="page_navigation" id="nav_performers" autocomplete="off" checked>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-9">
                            ...
                            <p class="text-white-50 small mb-md-0">
                                <?php 
                                if ($period_stats['total_points_awarded'] > 500) {
                                    echo "🎉 Outstanding period! Over 500 points awarded. The team is showing exceptional performance!";
                                } elseif ($period_stats['total_points_awarded'] > 250) {
                                    echo "📈 Great momentum! The team has earned over 250 points this period. Keep up the excellent work!";
                                } elseif ($period_stats['total_points_awarded'] > 0) {
                                    echo "💪 Good progress! Continue recognizing achievements to motivate the team.";
                                } else {
                                    echo "🌟 No points awarded this period. Start recognizing achievements to boost morale and performance!";
                                }
                                ?>
                            </p>
                        </div>
