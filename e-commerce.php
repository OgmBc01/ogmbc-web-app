...
?> 
  ...
  <section class="py-5">
    <div class="container">
      <div class="text-center mb-5">
        <h2 class="fw-bold" style="color:#d0aa4b;">Launching Your First E-Commerce Store</h2>
        <p class="lead">Step confidently into the online marketplace with our tailored support.</p>
      </div>
