...
?> 
  ...
  <section class="section bg-light text-dark">
    <div class="container">
      <div class="row align-items-center g-5">
        <div class="col-lg-6">
          <img src="resources/img/uk-company-formation.jpg" class="img-fluid rounded shadow" alt="uk company formation">
        </div>
        <div class="col-lg-6">
  ...
  <div class="container">
    <div class="text-center mb-5">
      <h2 class="fw-bold">Why Choose the UK for Company Formation?</h2>
      <p class="text-muted text-center">The United Kingdom is a global business hub with a robust and well
        regulated business environment. Setting up your company here offers
        numerous advantages, including access to a highly skilled workforce, a stable political climate, and a vast network of intern ati onal trade
        opportunities.
      </p>
    </div>
  </div>
